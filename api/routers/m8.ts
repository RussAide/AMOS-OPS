...
const rulesStore: WorkflowRule[] = [
  ...
  { id: "wr-doc-expired", name: "Document Expired Escalation", event: "document.expired", actions: [{ type: "escalate", target: "supervisor", priority: "urgent" }, { type: "notify", target: "qa-officer", priority: "high" }], enabled: true, created_at: "2026-01-15T10:00:00Z" },
  { id: "wr-incident-critical", name: "Critical Incident Response", event: "incident.critical", actions: [{ type: "escalate", target: "executive", priority: "urgent" }, { type: "notify", target: "clinical-director", priority: "urgent" }, { type: "notify", target: "qa-officer", priority: "high" }], enabled: true, created_at: "2026-02-01T09:00:00Z" },
  ...
  { id: "wr-claim-denied", name: "Claim Denied Alert", event: "revenue.claim-denied", actions: [{ type: "notify", target: "revenue-manager", priority: "high" }, { type: "escalate", target: "supervisor", priority: "medium" }], enabled: true, created_at: "2026-03-01T08:00:00Z" },
  { id: "wr-onboarding-complete", name: "Onboarding Complete — RTD Check", event: "onboarding.completed", actions: [{ type: "notify", target: "hr-director", priority: "medium" }, { type: "notify", target: "supervisor", priority: "medium" }], enabled: true, created_at: "2026-03-15T14:00:00Z" },
  { id: "wr-audit-finding", name: "Audit Finding — CAPA Required", event: "audit.finding-created", actions: [{ type: "escalate", target: "qa-officer", priority: "high" }, { type: "notify", target: "department-head", priority: "high" }], enabled: true, created_at: "2026-04-01T10:00:00Z" },
  { id: "wr-referral-new", name: "New Referral Assignment", event: "referral.created", actions: [{ type: "notify", target: "gro-admin", priority: "medium" }, { type: "log", target: "audit", priority: "low" }], enabled: true, created_at: "2026-04-15T09:00:00Z" },
  { id: "wr-equipment-failure", name: "Equipment Failure Response", event: "gad.equipment-failure", actions: [{ type: "escalate", target: "gad-ops", priority: "urgent" }, { type: "notify", target: "facility-manager", priority: "high" }], enabled: false, created_at: "2026-05-01T11:00:00Z" },
...
const instancesStore: WorkflowInstance[] = [
  { id: "wi1", rule_id: "wr-hr-status", rule_name: "HR Status Change Alert", event_type: "hr.status-changed", status: "completed", trigger_data: '{"personId":"h4","from":"applicant","to":"new-hire"}', triggered_by: "hr-director@adolbi.com", started_at: "2026-06-20T10:00:00Z", completed_at: "2026-06-20T10:00:05Z" },
  ...
  { id: "wi3", rule_id: "wr-incident-critical", rule_name: "Critical Incident Response", event_type: "incident.critical", status: "completed", trigger_data: '{"incidentId":"i1","type":"elopement","severity":"high"}', triggered_by: "rcs-day@adolbi.com", started_at: "2026-06-15T14:30:00Z", completed_at: "2026-06-15T14:35:00Z" },
  ...
  { id: "wi6", rule_id: "wr-referral-new", rule_name: "New Referral Assignment", event_type: "referral.created", status: "completed", trigger_data: '{"referralId":"r4","patientName":"Sophia Chen","type":"crisis"}', triggered_by: "gro.admin@adolbi.com", started_at: "2026-06-27T08:15:00Z", completed_at: "2026-06-27T08:15:03Z" },
  ...
  { id: "wi9", rule_id: "wr-hr-status", rule_name: "HR Status Change Alert", event_type: "hr.status-changed", status: "pending", trigger_data: '{"personId":"h5","from":"new-hire","to":"active"}', triggered_by: "hr-director@adolbi.com", started_at: "2026-06-28T09:00:00Z", completed_at: null },
  { id: "wi10", rule_id: "wr-equipment-failure", rule_name: "Equipment Failure Response", event_type: "gad.equipment-failure", status: "pending", trigger_data: '{"equipment":"network-switch","location":"server-closet"}', triggered_by: "gad.ops@adolbi.com", started_at: "2026-06-28T16:00:00Z", completed_at: null },
];

const approvalsStore: WorkflowApproval[] = [
  { id: "wa1", instance_id: "wi4", rule_name: "Claim Denied Alert", approver_role: "revenue-manager", event_type: "revenue.claim-denied", status: "pending", requested_at: "2026-06-12T09:00:00Z", responded_at: null, decision: null, approver_id: null },
  ...
  { id: "wa3", instance_id: "wi10", rule_name: "Equipment Failure Response", approver_role: "gad-ops", event_type: "gad.equipment-failure", status: "pending", requested_at: "2026-06-28T16:00:00Z", responded_at: null, decision: null, approver_id: null },
];
  ...
  respondApproval: authedQuery
    ...
    .mutation(({ ctx, input }) => {
      ...
      auditStore.push({
        ...
        details: `${approval.rule_name} ${input.decision} by ${input.approverId}`, created_at: now,
      });
