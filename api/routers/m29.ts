...
const ENTITY_DB: Entity[] = [
  { id: "y1", type: "youth", title: "Marcus Johnson", subtitle: "BHC-2026-001 • Age 16 • Residential", module: "Clinical", status: "active", lastUpdated: "2026-07-02", tags: ["trauma", "CBT", "conduct-disorder"], relevance: 1.0 },
  { id: "y2", type: "youth", title: "Aaliyah Williams", subtitle: "BHC-2026-002 • Age 16 • Residential", module: "Clinical", status: "active", lastUpdated: "2026-07-02", tags: ["anxiety", "depression", "mood-disorder"], relevance: 1.0 },
  { id: "y3", type: "youth", title: "Carlos Martinez", subtitle: "BHC-2026-003 • Age 15 • Assessment", module: "Clinical", status: "assessment", lastUpdated: "2026-06-29", tags: ["conduct-disorder", "intake-pending", "CANS"], relevance: 0.95 },
  { id: "y4", type: "youth", title: "Jada Thompson", subtitle: "BHC-2026-004 • Age 17 • Crisis Stabilization", module: "Clinical", status: "hold", lastUpdated: "2026-07-01", tags: ["behavioral", "peer-conflict", "safety-plan"], relevance: 0.9 },
  { id: "ir-0701", type: "incident", title: "Peer Conflict — Jada Thompson", subtitle: "2026-07-01 14:30 • Moderate severity • Resolved", module: "Compliance", status: "resolved", lastUpdated: "2026-07-01", tags: ["behavioral", "peer-conflict", "Jada-Thompson"], relevance: 0.85 },
  ...
  { id: "ir-0615", type: "incident", title: "Behavioral Event — Marcus Johnson", subtitle: "2026-06-15 21:15 • High severity • PRN administered", module: "Compliance", status: "resolved", lastUpdated: "2026-06-16", tags: ["behavioral", "medication", "PRN", "Marcus-Johnson"], relevance: 0.88 },
  { id: "ca-0701", type: "chart_audit", title: "Chart Audit — Jada Thompson", subtitle: "Auditor: Lilian Ike • 6/9 areas passed • Pass with notes", module: "Compliance", status: "pass_with_notes", lastUpdated: "2026-07-01", tags: ["audit", "Jada-Thompson", "deficiency"], relevance: 0.82 },
  { id: "tx-001", type: "treatment_plan", title: "Treatment Plan — Marcus Johnson", subtitle: "CBT-based • 6-month residential • Goals: 4 active", module: "Clinical", status: "active", lastUpdated: "2026-06-15", tags: ["CBT", "trauma", "residential", "Marcus-Johnson"], relevance: 0.92 },
  { id: "tx-002", type: "treatment_plan", title: "Treatment Plan — Aaliyah Williams", subtitle: "DBT-informed • Mood regulation focus • Goals: 3 active", module: "Clinical", status: "active", lastUpdated: "2026-06-20", tags: ["DBT", "mood-disorder", "residential", "Aaliyah-Williams"], relevance: 0.91 },
  { id: "med-001", type: "medication_order", title: "Medication Order — Sertraline 50mg", subtitle: "Marcus Johnson • Daily PO • Active since 2026-04-01", module: "Residential", status: "active", lastUpdated: "2026-06-01", tags: ["medication", "SSRI", "Marcus-Johnson", "psychiatric"], relevance: 0.87 },
  { id: "med-002", type: "medication_order", title: "Medication Order — Methylphenidate 20mg", subtitle: "Aaliyah Williams • Daily PO • Active since 2026-04-15", module: "Residential", status: "active", lastUpdated: "2026-06-01", tags: ["medication", "stimulant", "Aaliyah-Williams", "ADHD"], relevance: 0.86 },
  ...
  { id: "auth-001", type: "authorization", title: "Authorization — Marcus Johnson", subtitle: "Texas Medicaid • Approved • Auth #TXM-88765432", module: "Revenue", status: "approved", lastUpdated: "2026-04-01", tags: ["authorization", "Medicaid", "Marcus-Johnson"], relevance: 0.8 },
  { id: "doc-001", type: "document", title: "Intake Assessment — Carlos Martinez", subtitle: "CANS Score: Pending • 6/10 checklist items complete", module: "Clinical", status: "in_progress", lastUpdated: "2026-06-29", tags: ["intake", "assessment", "CANS", "Carlos-Martinez"], relevance: 0.83 },
