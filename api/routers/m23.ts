...
function actorFromContext(user: {
  ...
  if (!m23RoleSet.has(user.role)) {
    throw new TRPCError({
      code: "FORBIDDEN",
      message: "This role is outside the governed MHRS workflow.",
    });
  }
  return {
    id: user.id,
...
const syntheticM23RuntimeEnabled = (() => {
  try {
...
function assertM23SyntheticProvider(): void {
  if (!syntheticM23RuntimeEnabled) {
    throw new TRPCError({
      code: "SERVICE_UNAVAILABLE",
      message:
        "MHRS prototype operations are unavailable because no durable Production provider is configured.",
    });
  }
}

export function resetM23SyntheticState(): M23SyntheticState {
  assertM23SyntheticProvider();
...
export const m23Router = createRouter({
  dashboard: authedQuery
    ...
    .query(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.getDashboard(
  ...
  caseDetail: authedQuery
    ...
    .query(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.getCaseDetail(
          actorFromContext(ctx.user),
          input.caseId,
          input.asOf,
        ),
  ...
  registerCase: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.registerCase(
          actorFromContext(ctx.user),
          input.case as RegisterM23CaseInput,
          input.at,
        ),
      ),
    ),
  ...
  recordNeed: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.recordNeed(
          actorFromContext(ctx.user),
          input.caseId,
          input.need as RecordM23NeedInput,
          input.at,
        ),
      ),
    ),
  ...
  createPlanVersion: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.createPlanVersion(
          actorFromContext(ctx.user),
          input.caseId,
          input.plan as CreateM23PlanInput,
          input.at,
        ),
      ),
    ),
  ...
  addGoal: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.addGoal(
          actorFromContext(ctx.user),
          input.planVersionId,
          input.goal as CreateM23GoalInput,
          input.at,
        ),
      ),
    ),
  ...
  addIntervention: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.addIntervention(
          actorFromContext(ctx.user),
          input.planVersionId,
          input.intervention as CreateM23InterventionInput,
          input.at,
        ),
      ),
    ),
  ...
  transitionPlan: authedQuery
    .input(
      z.object({
        at: timestamp,
        planVersionId: id,
        toState: z.enum(["under_review", "approved", "superseded"]),
        reason: detail,
      }),
    )
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.transitionPlan(
          actorFromContext(ctx.user),
          input.planVersionId,
          input.toState,
          input.reason,
  ...
  documentSession: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.documentSession(
          actorFromContext(ctx.user),
          input.caseId,
          input.session as DocumentM23SessionInput,
          input.at,
        ),
      ),
    ),
  ...
  signSession: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.signSession(
          actorFromContext(ctx.user),
          input.sessionId,
          input.signature,
          input.at,
  ...
  evaluateReviewAlerts: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.evaluateReviewAlerts(
          actorFromContext(ctx.user),
          input.asOf,
        ),
      ),
  ...
  completeReview: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.completeReview(
          actorFromContext(ctx.user),
          input.alertId,
          input.plan as CreateM23PlanInput,
          input.at,
  ...
  requestClaimHandoff: authedQuery
    ...
    .mutation(({ ctx, input }) =>
      callM23(() =>
        getM23SyntheticState().engine.requestClaimHandoff(
          actorFromContext(ctx.user),
          input.sessionId,
          input.at,
        ),
