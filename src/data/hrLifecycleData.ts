...
export const SAMPLE_PEOPLE: HRPerson[] = [
  ...
  { id: "p-005", firstName: "Emily", lastName: "Foster", employeeId: "EMP-1005", role: "Supervisor", department: "Clinical", lane: "management", isEmployee: true, moduleStatuses: { recruitment: "r-closed", screening: "s-selected", offers: "o-file-ready", orientation: "or-signed", onboarding: "ob-comp-done", clearance: "c-restricted", "personnel-files": "pf-complete", credentials: "cr-expiring", performance: "pa-open", compliance: "ca-in-review" }, hireDate: "2025-01-20", supervisor: "Dr. James Wilson", isActive: true },
  ...
  { id: "p-015", firstName: "Kevin", lastName: "Thompson", employeeId: "EMP-1015", role: "Clinical Staff", department: "Behavioral Health", lane: "management", isEmployee: true, moduleStatuses: { recruitment: "r-closed", screening: "s-selected", offers: "o-file-ready", orientation: "or-signed", onboarding: "ob-comp-done", clearance: "c-cleared", "personnel-files": "pf-complete", credentials: "cr-renewal", performance: "pa-closed", compliance: "ca-in-review" }, hireDate: "2024-11-15", supervisor: "Dr. James Wilson", isActive: true },
  ...
  { id: "p-018", firstName: "Nicole", lastName: "Clark", employeeId: "EMP-1018", role: "Clinical Staff", department: "Behavioral Health", lane: "management", isEmployee: true, moduleStatuses: { recruitment: "r-closed", screening: "s-selected", offers: "o-file-ready", orientation: "or-signed", onboarding: "ob-comp-done", clearance: "c-cleared", "personnel-files": "pf-complete", credentials: "cr-expired", performance: "pa-closed", compliance: "ca-deficiency" }, hireDate: "2024-10-01", supervisor: "Dr. James Wilson", isActive: true },
  ...
  { id: "p-024", firstName: "Sandra", lastName: "Scott", employeeId: "EMP-1024", role: "Clinical Staff", department: "Behavioral Health", lane: "management", isEmployee: true, moduleStatuses: { recruitment: "r-closed", screening: "s-selected", offers: "o-file-ready", orientation: "or-signed", onboarding: "ob-comp-done", clearance: "c-cleared", "personnel-files": "pf-complete", credentials: "cr-current", performance: "pa-followup", compliance: "ca-not-started" }, hireDate: "2025-04-10", supervisor: "Dr. James Wilson", isActive: true },
