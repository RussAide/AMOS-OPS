...
import { Upload, X, File, FileText, Image, FileSpreadsheet, CheckCircle, AlertTriangle } from "lucide-react";
...
// File type icon helper - exported for external use
export function getFileIcon(type: string) {
  ...
  if (type.includes("word") || type.includes("document")) return <FileText size={20} style={{ color: "#2563EB" }} />;
  if (type.includes("sheet") || type.includes("excel")) return <FileSpreadsheet size={20} style={{ color: "#059669" }} />;
